export default function ($abstract) {
	const ENTITY = {
		name: "post",
		table_name: "gauze__post",
		primary_key: "id",
		graphql_meta_type: "POST",
		...
		fields: {
			id: {
				...
				allowed_agent_types: ["gauze__agent_root", "gauze__agent_account", "gauze__agent_user", "gauze__agent_person", "gauze__agent_character"],
			},
			created_at: {
				name: "created_at",
				indexed: true,
